...
import { useCompanyNotes } from "@/hooks/useClientNotes";
...
export const CompanyNotesTab = ({ companyId }: Props) => {
  ...
  // Client-side Suche: Content + Autor-Name + Datum
    ...
    return notes.filter((n) => {
      ...
      for (const iso of dates) {
        ...
        const haystacks = [
          ...
          d.toLocaleDateString("de-CH", { month: "short" }).toLowerCase(),
          d.toLocaleDateString("de-CH", { month: "long" }).toLowerCase(),
        ];
