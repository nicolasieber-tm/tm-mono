...
const PRODUCTS = [
  ...
  { name: "OneClick Office", logo: "/oneclick-office_logo.png", color: "#2b9fd6", grad: "linear-gradient(135deg,#3bb0e6,#1f7fc0)", tag: "Coaches & Berater", domain: "oneclick-office.ch", href: "https://start.oneclick-office.ch", desc: "Rechnungen, Spesen und Admin-Kram radikal vereinfacht, damit Coaches, Berater und kleine Unternehmen wieder die Arbeit machen, für die sie bezahlt werden." },
        ...
        <div className="wide">
          <div className="grid">
            ...
            <div>
              ...
              <a className="fl" href="https://start.oneclick-office.ch">OneClick Office</a>
