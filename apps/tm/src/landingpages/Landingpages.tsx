...
const Landingpages = () => {
  ...
  useEffect(() => {
    document.body.classList.add("lp-light");
  ...
  return (
    <div className="lp lp-vivid lp-web" ref={rootRef}>
      ...
      <nav className="lp-nav">
        <div className={`lp-pill${scrolled ? " scrolled" : ""}`}>
          <Link className="b" to="/"><img className="brandmark" src="/Webseiten_logo.png" alt="" />Trending Media</Link>
          <div className="links">
          ...
          <button className="lp-burger" aria-label="Menü öffnen" onClick={() => setMobileOpen((o) => !o)}>≡</button>
        </div>
      </nav>
      ...
      <section className="lp-hero reveal" id="top">
        <div className="wrap">
      ...
      <section className="lp-sec alt" id="problem">
        <div className="wide">
          ...
          <div className="lp-grid c4 reveal">
            {PAINS.map((p) => (
      ...
      <section className="lp-sec" id="leistungen">
        <div className="wide">
          ...
          <div className="lp-grid c2 reveal">
            {SERVICES.map((s) => (
      ...
      <section className="lp-sec alt" id="vorgehen">
        <div className="wide">
          <Shead k="Vorgehen" h="Struktur vor Optik. Wirkung vor Effekt." />
          <div className="lp-grid c4 reveal">
            {PROCESS.map((s, i) => (
              <div className="lp-card" key={s.t}>
                <div className="lp-num">{n2(i)}</div>
                <h3>{s.t}</h3>
                <p>{s.d}</p>
              </div>
            ))}
          </div>
          <div className="lp-cta reveal" style={{ marginTop: 48 }}>
            <a href="#kontakt">Erstgespräch buchen</a>
          </div>
        </div>
      </section>

      <section className="lp-sec alt" id="referenz">
        <div className="wide">
      ...
      <section className="lp-sec" id="buchung">
        <div className="wide">
      ...
      <section className="lp-sec">
        <div className="wide">
          ...
          <div className="lp-grid c2 reveal">
            {REASONS.map((r) => (
              <div className="lp-reason" key={r.t}>
      ...
      <section className="lp-sec alt" id="pakete">
        <div className="wide">
          ...
          <div className="lp-grid c4 reveal">
            {PACKAGES.map((p) => (
              <div className={`lp-card pkg${p.pop ? " pop" : ""}`} key={p.name}>
      ...
      <section className="lp-sec" id="kontakt">
        <div className="wide">
          <div className="lp-contact reveal">
            ...
            <div className="lp-cal">
              ...
              <div className="lp-book">
                ...
                <button type="button" className="lp-book-btn" data-book-widget="">Jetzt Termin buchen →</button>
              </div>
            </div>
          </div>
        </div>
